...
class OpenStackWorkloadMgrShell(object):
    ...
    def get_base_parser(self):
        ...
        parser.add_argument('--version',
                            action='version',
                            version=workloadmgrclient.__version__)

        parser.add_argument('--debug',
                            action='store_true',
                            default=utils.env('WORKLOADMGRCLIENT_DEBUG',
                                              default=False),
        ...
        parser.add_argument('--projectid', '--tenant_name', dest='projectid',
                            default=utils.env('WORKLOADMGR_PROJECT_ID'),
                            help=argparse.SUPPRESS)
    ...
    def _discover_extensions(self, version):
        ...
        for name, module in itertools.chain(
            ...
            extension = workloadmgrclient.extension.Extension(name, module)
    ...
    def main(self, argv):
        ...
        if insecure == 'True' or insecure == 'TRUE' or insecure == 'true':
           insecure = True
        elif insecure == 'False' or insecure == 'FALSE' or insecure == 'false':
             insecure = False
        ...
        self.cs = client.Client(options.os_workload_api_version, os_username,
    ...
    def do_bash_completion(self, args):
        ...
        workloadmgr.bash_completion script doesn't have to hard code them.
        """
        commands = set()
        options = set()
...
def main():
    try:
        OpenStackWorkloadMgrShell().main(map(strutils.safe_decode, sys.argv[1:]))
