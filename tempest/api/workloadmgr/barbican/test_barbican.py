    ...
    def test_6_barbican(self):
        try:
            ...
            workload_create_with_encryption = command_argument_string.workload_create_with_encryption + \
                              ...
                              " --secret-uuid " + self.secret_uuid
            error = cli_parser.cli_error(workload_create_with_encryption)
            if error and (str(error.strip('\n')).find('ERROR') != -1):
                LOG.debug("workload with encryption creation unsuccessful")
                raise Exception(
                ...
                if rc != 0:
                    ...
                    LOG.debug("Command executed correctly : " + rc)
                tests[0][1] = 1
                reporting.test_case_to_write()
            ...
            if (self.wid is None):
                ...
                raise Exception("Create encrypted workload api created with invalid secret UUID")
