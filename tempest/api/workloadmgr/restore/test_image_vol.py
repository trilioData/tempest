...
class WorkloadTest(base.BaseWorkloadmgrTest):
    ...
    def test_1_image_volume(self):
        try:
            ...
            deleted = 0
            ## VM and Workload ###
            tests = [['tempest.api.workloadmgr.restore.test_image_vol_Selective-restore', 0],
                     ['tempest.api.workloadmgr.restore.test_image_vol_Inplace-restore', 0], ['tempest.api.workloadmgr.restore.test_image_vol_Oneclick-restore', 0]]
