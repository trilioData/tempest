...
class WorkloadsTest(base.BaseWorkloadmgrTest):
    ...
    def test_create_workload(self):
        ...
        self.schedule = {"retention_policy_type": "Number of days to retain Snapshots", "enabled": self.enabled,
                         "start_date": self.start_date, "start_time": self.start_time, "retention_policy_value": 1}
        ...
        self.assertEqual(self.getRetentionPolicyTypeStatus(
            self.workload_id), 'Number of days to retain Snapshots')
        self.assertEqual(
