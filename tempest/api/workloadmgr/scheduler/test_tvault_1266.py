...
class WorkloadsTest(base.BaseWorkloadmgrTest):
    ...
    def test_create_workload(self):
        ...
        self.enabled = True
	self.schedule = {"fullbackup_interval": "2", "retention_policy_type": "Number of Snapshots to Keep", "enabled": self.enabled, "start_date": self.start_date, "start_time": self.start_time, "retention_policy_value": 3}
	...
	print self.schedule
        ...
        self.assertEqual(self.getFullBackupIntervalStatus(self.workload_id), '2')
