...
class WorkloadsTest(base.BaseWorkloadmgrTest):
	...
	try:
	    ...
	    LOG.debug("gloabal parameters: {0} {1} {2} {3} {4} {5} {6}".format(str(instances_ids), str(snapshot_ids), str(date_from), str(date_to), str(wid), str(volume_ids), str(security_group_id)))
