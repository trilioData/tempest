...
class WorkloadsTest(base.BaseWorkloadmgrTest):
    ...
    def test_tvault_filesearch_daterange(self):
        try:
	    ...
	    filesearch_id = self.filepath_search(vmid_to_search, filepath_to_search, snapshot_ids_tosearch, start_snapshot, end_snapshot, self.date_from, self.date_to)
	    ...
	    for snapshot_id in snapshot_wise_filecount.keys():
    	        if filecount_in_snapshots[snapshot_id] == snapshot_wise_filecount[snapshot_id] and snapshot_id in self.snapshot_ids[1:]:
