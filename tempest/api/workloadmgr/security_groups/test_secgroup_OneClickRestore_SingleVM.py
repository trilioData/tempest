...
class RestoreTest(base.BaseWorkloadmgrTest):
    ...
    def test_secgroup_OneClickRestore_SingleVM(self):
        #Prerequisites
        self.created = False
        self.workload_instances = []
        
        #Create security groups
        self.sec_grp_id_1 = self.create_security_group(tvaultconf.security_group_name + "_1")
        self.add_security_rule(self.sec_grp_id_1, "TCP", 1, 65535)
        
        self.sec_grp_id_2 = self.create_security_group(tvaultconf.security_group_name + "_2")
        self.add_security_rule(self.sec_grp_id_1, "TCP", 1, 65535, self.sec_grp_id_1)
        
        #Launch instance
        self.vm_id = self.create_vm(vm_cleanup=False, security_group_id=self.sec_grp_id_1)
