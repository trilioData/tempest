...
#openstack --insecure secret commands
openstack_create_secret_with_empty_payload = "openstack --insecure secret store -p \"\" -f json "
...
policy_update = "workloadmgr --insecure policy-update "
...
dms_mount = "workloadmgr --insecure dms-mount "

#OpenStack commands
rbac_create_secgroup = "openstack --insecure network rbac create --target-project "
os_server_list = "openstack --insecure server list"

#OpenStack WLM CLI Commands
os_workload_list = "openstack --insecure workloadmgr --insecure workload list"

#VM Migration commands
migration_plan_create = "workloadmgr --insecure migration-plan-create --display-name " + \
        tvaultconf.migration_plan_name + " --display-description '" + \
        tvaultconf.migration_plan_desc + "' --source-platform vmware -f json "
migration_plan_list = "workloadmgr --insecure migration-plans-list -c ID -f json"
migration_plan_delete = "workloadmgr --insecure migration-plan-delete "
migration_plan_show = "workloadmgr --insecure migration-plan-show -f json "
migration_discover_vms = "workloadmgr --insecure migration-plan-discover-vms "
